...
class OMRSubmission(models.Model):
    ...
    participant = models.OneToOneField(Participant, on_delete=models.CASCADE, related_name='omr_submission')
    ...
    answer_key = models.ForeignKey(AnswerKey, on_delete=models.PROTECT, related_name='submissions')
