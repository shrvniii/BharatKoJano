...
def get_row_y_coordinate(r):
    ...
    block_idx = r // 5
    row_in_block = r % 5
    # Each row is 18pt, each block gap is 15pt. Starts at Y=590.
...
def generate_blank_omr_pdf(filename):
    ...
    # 1. Header Information Table (matches the style of the user's image)
    ...
    # Anchor coordinates (Centers)
    # TL: (40, 660), TR: (555, 660), BL: (40, 60), BR: (555, 60)
    anchor_size = 14
